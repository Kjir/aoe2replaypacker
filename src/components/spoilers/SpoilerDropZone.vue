...
<template>
    <div class="flex items-center justify-center w-full mt-4" @dragenter.prevent @dragover.prevent
        ...
        <label for="dropzone-file"
            ...
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                <svg class="w-12 h-12 mb-4 text-gray-500 dark:text-gray-400" fill="currentColor" aria-hidden="true"
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">One or multiple aoe2record savegames or a zip file
                    containing them</p>
            </div>
            <input id="dropzone-file" accept=".aoe2record, .zip, .rar, .7z" multiple type="file" class="hidden"
