  ...
  <div class="flex items-center justify-center w-full mt-4">
    <label for="dropzone-file"
      ...
      <div class="flex flex-col items-center justify-center pt-5 pb-6">
        ...
        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to add game(s)</span>
          or
          drag and drop</p>
        <p class="text-xs text-gray-500 dark:text-gray-400">One or multiple aoe2record savegames</p>
      </div>
      <input id="dropzone-file" ref="fileInput" accept=".aoe2record" multiple type="file" class="hidden"
